...
if(lander.isTouching(block30)){
  lander.setPosition(50,120,30,30)
  lander.collide(block30)
}

if(lander.isTouching(block31)){
  lander.setPosition(50,120,30,30)
  lander.collide(block31)
}

if(lander.isTouching(block32)){
  lander.setPosition(50,120,30,30)
  lander.collide(block32)
}

if(lander.isTouching(block37)){
  lander.setPosition(50,120,30,30)
  lander.collide(block37)
}

if(lander.isTouching(block38)){
  lander.setPosition(50,120,30,30)
  lander.collide(block38)
}

if(lander.isTouching(block39)){
  lander.setPosition(50,120,30,30)
  lander.collide(block39)
}

if(lander.isTouching(block40)){
  lander.setPosition(50,120,30,30)
  lander.collide(block40)
}
